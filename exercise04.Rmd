...
essential_by_borough %>%
  ggplot(mapping = aes(x = BOROUGH, y = total)) +
  geom_col()
...
essential_by_cat %>%
  ggplot(mapping = aes(x = CATEGORY, y = total)) +
...
essential_by_both %>%
  ggplot() + geom_tile(mapping = aes(x = BOROUGH, y = CATEGORY, fill = total))
